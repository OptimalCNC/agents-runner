...
import { apiGetBundledMcpStatus, apiInstallBundledMcp } from "../state/api.js";
...
type McpHealthTone = "healthy" | "warning" | "idle";

function getMcpHealthTone(status: BundledMcpStatus | null): McpHealthTone {
  if (!status) {
    return "idle";
  }
  ...
  return (
    <div className="settings-page">
      <header className="settings-hero">
        ...
        <h1>Integrations</h1>
        <p>
          Manage the local Codex MCP configuration that Agents Runner uses for Review commits.
        </p>
      </header>
